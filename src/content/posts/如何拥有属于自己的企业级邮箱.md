...
![image.png](https://img.raynard.lol/file/blog/1779548296490.png)
...
/mail-worker
```
![image.png](https://img.raynard.lol/file/blog/1779548338768.png)
> [!WARNING] WARNING
...
![image.png](https://img.raynard.lol/file/blog/1779547816629.png)
- 名称建议：`cloud-mail-kv`（这个随意）

## 2.绑定 KV
进入 Worker → **Settings** → **Bindings** → **Add binding**
![image.png](https://img.raynard.lol/file/blog/1779547973631.png)
![image.png](https://img.raynard.lol/file/blog/1779548165498.png)
![image.png](https://img.raynard.lol/file/blog/1779548120662.png)
- 类型：KV Namespace
...
![image.png](https://img.raynard.lol/file/blog/1779548082334.png)
...
![image.png](https://img.raynard.lol/file/blog/1779547602364.png)
...
![image.png](https://img.raynard.lol/file/blog/1779548991145.png)
...
![image.png](https://img.raynard.lol/file/blog/1779549142883.png)
...
```
如图手动添加在cf的dns记录上
![image.png](https://img.raynard.lol/file/blog/1779533697280.png)

> [!IMPORTANT] IMPORTANT
> 添加 DKIM、SPF、DMARC 后，邮件更不容易进垃圾箱。DNS 修改后等待 5-30 分钟生效，并将邮件相关记录设为 **DNS Only**（灰色云朵）。

4. 创建 Full Access API Key
![image.png](https://img.raynard.lol/file/blog/1779549153233.png)
